package com.indicia.worldwide.config;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	/*
	 * Generating Key keytool -genkeypair -alias indicia -keyalg RSA -keypass
	 * worldwide -keystore indicia.jks -storepass worldwide
	 * 
	 * keytool -list -rfc --keystore indicia.jks | openssl x509 -inform pem -pubkey
	 * 
	 */
	 ...
	 * endpoints) throws Exception { endpoints.tokenStore(new
	...
	public void configure(ClientDetailsServiceConfigurer clientDetailsServiceConfigurer) throws Exception {
		clientDetailsServiceConfigurer.inMemory().withClient("coupon-client-app").secret(passwordEncoder.encode("9999"))
